 ...
 *
 * Compatible with:
 *   - cPanel/WHM: /usr/local/cpanel/whostmgr/docroot/cgi/imh-ai-assistant/index.php
 *   - CWP:       /usr/local/cwpsrv/htdocs/resources/admin/modules/imh-ai-assistant.php
 *
...
define('IMH_DNS_CACHE_DIR', '/var/cache/imh-ai-assistant');
...
if ($isCPanelServer) {
  ...
  WHM::header('imh-ai-assistant WHM Interface', 0, 0);
} else {
  echo '<div class="panel-body">';
};

$cssPath = $isCWPServer ? 'design/css/imh-ai-assistant.css' : 'imh-ai-assistant.css';
...
$img_src = $isCWPServer ? 'design/img/imh-ai-assistant.png' : 'imh-ai-assistant.png';
echo '<h1 class="imh-title"><img src="' . htmlspecialchars($img_src) . '" alt="ai-assistant" class="imh-title-img" />DNS Manager</h1>';
...
echo '<div class="tabs-nav" id="imh-tabs-nav">
    <button type="button" class="active" data-tab="tab-ai-assistant" aria-label="DNS Manager tab">DNS Manager</button>
...
echo '<div id="tab-ai-assistant" class="tab-content active">';
...
$jsPath = $isCWPServer ? 'design/js/imh-ai-assistant.js' : 'imh-ai-assistant.js';

if ($isCPanelServer) {
  echo '<script type="module" crossorigin src="imh-ai-assistant.js"></script>';
} else {
...
echo '<div class="imh-footer-box"><img src="' . htmlspecialchars($img_src) . '" alt="ai-assistant" class="imh-footer-img" /><p>Plugin by <a href="https://inmotionhosting.com" target="_blank">InMotion Hosting</a>.</p></div>';
